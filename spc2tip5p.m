%% spc2tip5p.m
% * This function converts a .gro or .pdb file with spc water to some tip5p water
...
% * The coordinate of the new MW centers is set to OW coordinates, thus must be properly energy minimized
% * this could easliy be avoided if using an unwrapped structure...
% * Tested 15/04/2017

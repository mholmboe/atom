...
% # <write_atom(atom,Box_dim,filename_out)> % This function writes the below listed files depending on the filename and passed variables, ie either a .gro|.pdb|.xyz|.itp and so on
% # <write_atom_cif(atom,Box_dim,filename_out)> % This function writes a basic .cif file from the atom struct

...
% * with a distance r [1x1 or 1x2] away from the atoms in the atom1 struct. There is
% * also a possibility to use a twin-range cutoff approach (suitable for
% * OH2), by setting r(2) to a smaller value than r(1).
% * Tested 15/04/2017

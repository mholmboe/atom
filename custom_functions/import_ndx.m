...
%
%% Examples
% # ndx = import_ndx(filename) % Basic input arguments
% # ndx = import_ndx(filename,atom) % Will generate new atom structs from the defined groups

function ndx = import_ndx(filename,varargin)

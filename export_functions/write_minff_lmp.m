...
%
%% Examples
% # write_minff_lmp(atom,Box_dim,filename) % Basic input arguments
% # write_minff_lmp(atom,Box_dim,filename,ff) % ff being a MATLAB struct containing forcefield parameters
%

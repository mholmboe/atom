...
% * atom = interface_atom(atom,Box_dim,'interface','spc','edge')
...
for assignment_run=1:heal
    ...
    %
    %     AlO=(Al+O'>1)+(Al'+O>1);     radius_limit(AlO>0)=2.5; % 2.8
    %     MgoO=(Mgo+O'>1)+(Mgo'+O>1);  radius_limit(MgoO>0)=2.5; % 2.8

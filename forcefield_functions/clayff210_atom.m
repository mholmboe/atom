...
%
%% Examples
% # atom=clayff210_atom(atom,Box_dim)
% # atom=clayff210_atom(atom,Box_dim,'clayff','spc')
% # atom=clayff210_atom(atom,Box_dim,'clayff','spc',heal_iterations)

function atom=clayff210_atom(atom,Box_dim,varargin)
%%
format compact;

...
nlayers=2;
Full_Box_dim=[25.9590  27.0459  nlayers*d001]; % The x and y values comes from the .pdb file
nSOL=225;%UCinX*UCinY*5*3; % 5 water molecules per unit cell and monolayer per MMT layer is reasonable 
Cation='Na';nCation=10; % The original .car file contains 10 counterions
System=[];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%% Add mineral lattices
%% atom = import_atom(filename,translation_vector,Full_Box_dim)
MMT1 = import_atom('mont0_333_K_15_single_layer.pdb',[0 0 0],Full_Box_dim); System = update_atom({System MMT1});
MMT2 = import_atom('mont0_333_K_15_single_layer.pdb',[2*5.2/3 2*9/3 d001],Full_Box_dim); System = update_atom({System MMT2});
[System.resname]=deal({'MMT'});

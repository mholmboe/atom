...
define		= -DFLEXIBLE -D$watermodel -DPOSRES_CTAB -DPOSRES_Ion -DPOSRES_noH ; Use felxible SPC/E during miniposition restrain the protein
...
$run_grompp -f ./"$sim".mdp -c pre"$sim".gro -p $gmx_run/$moldir/topol.top -n $gmx_run/$moldir/index.ndx -o "$sim".tpr -pp -po -maxwarn 2

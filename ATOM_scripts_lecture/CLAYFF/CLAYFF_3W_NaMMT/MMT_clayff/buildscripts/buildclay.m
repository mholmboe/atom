...
write_atom_itp(atom,Box_dim,'MMT_clayff_2004_3.itp',1.25,1.25,'clayff','spc');
write_atom_gro(atom,Box_dim,'MMT_clayff_2004_3'); % Print the clay sheet to a .gro file
...
% atom=tweak_charge_atom(atom); % This function tries to tweak the charge if it is not exactly an integer. Passing an additional argument such as {'Si'} only tweaks the charge of the atomtype Si 
write_atom_itp(atom,Box_dim,'MMT_clayff_3.itp',1.25,1.25,'clayff','spc');
write_atom_gro(atom,Box_dim,'MMT_clayff_3'); % Print the clay sheet to a .gro file
...
atom=tweak_charge_atom(atom); % This function tries to tweak the charge if it is not exactly an integer. Passing an additional argument such as {'Si'} only tweaks the charge of the atomtype Si 
write_atom_itp(atom,Box_dim,'MMT_interface_3.itp',1.25,2.25,'interface','spc');
write_atom_gro(atom,Box_dim,'MMT_interface_3'); % Print the clay sheet to a .gro file

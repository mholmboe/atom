...
MMT1 = import_atom('MMT_minff_1.gro',[0 0 0],Full_Box_dim); System = update_atom({System MMT1});
MMT2 = import_atom('MMT_minff_2.gro',[5.2/3 9/3 d001],Full_Box_dim); System = update_atom({System MMT2});
...
% write_atom_all(System,Full_Box_dim,'system',1.25,2.25,'minff','spc/e');

...
% Ion1 = create_atom(Cation,Cation,[0 0 0 Full_Box_dim(1) Full_Box_dim(2) Full_Box_dim(3)/2],2,nCation,System); System = update_atom({System Ion1});
% Ion2 = create_atom(Cation,Cation,[0 0 Full_Box_dim(3)/2 Full_Box_dim(1) Full_Box_dim(2) Full_Box_dim(3)],2,nCation,System); System = update_atom({System Ion2});
%vmd(System,Full_Box_dim);

...
for i=1:size(atom,2)
    ...
    elseif strncmpi(atom(i).type,{'CAL'},2);atom(i).element={'Ca'};
    elseif strncmpi(atom(i).type,{'CES'},2);atom(i).element={'Cs'};
    elseif strncmpi(atom(i).type,{'CLA'},2);atom(i).element={'Cl'};
    ...
    % elseif strncmpi(atom(i).type,{'Hg'},2);atom(i).element={'Hg'}; % Who models Hg anyway?
    ...
    elseif strncmpi(atom(i).type,{'POT'},3);atom(i).element={'K'};
    ...
    elseif strncmpi(atom(i).type,{'SOD'},2);atom(i).element={'Na'};
